 ...
 * chunked — which Apache HttpClient 5 (used by Spring Cloud Gateway MVC and
 * OpenFeign in Spring Cloud 2025.x) throws NotImplementedException on.
 */
@Component
public class ContentLengthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // Copies buffered body → sets Content-Length → no chunked encoding
